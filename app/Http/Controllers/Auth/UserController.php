...
class UserController extends Controller
{
    ...
    {
        $roles = Role::where('name', '!=', 'agent')->pluck('name', 'id')->toArray();

        $groups = AgentGroup::pluck('grpagen_name', 'grpagen_id')->toArray();

        return view('auth.user.create', compact('roles', 'groups'));
    }
    ...
    public function edit($id)
    {
        ...
        return view('auth.user.edit', compact('roles', 'data', 'groups'));
    }
    ...
    public function changePassword(Request $request)
    {
        ...
        flash('Password Berhasil Dirubah')->success();
