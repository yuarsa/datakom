            ...
            columns: [
                {
                    ...
                    render: function ( data, type, row ) {
                        if(data.status_id == 0) {
                            return '<input type="checkbox" style="margin-top: 0;vertical-align: middle" name="work_order_id[]" class="cbPilih" value="'+ data.order_id +'|'+ data.li_status +'">';
                        } else {
                            return '';
                        }
                    }
