<header class="main-header">
    ...
    <a href="{{ url('/') }}" class="logo">
        <span class="logo-mini"><img src="{{ asset('img/logo.png') }}" class="top-logo-mini" width="35"></span>
        <span class="logo-lg"><img src="{{ asset('img/logo.png') }}" class="top-logo-lg" width="120">
        </span>
    </a>
    <!-- Header Navbar -->
            ...
            <ul class="nav navbar-nav">
                ...
                <li class="dropdown notifications-menu">
                    ...
                    <ul class="dropdown-menu">
                        <li>
                            <ul class="menu">
                                <li class="footer"><a href="{{ url('auth/change-password') }}"><i class="fa fa-key"></i> Ganti Password</a></li>
                                <li class="footer">
